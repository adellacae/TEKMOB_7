...
class MailPreviewCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final currentEmailStarred =
        Provider.of<EmailStore>(context, listen: false).isEmailStarred(email);
    final mailPreview =
        _MailPreview(id: id, email: email, onStar: onStar, onDelete: onDelete);
    final onStarredInbox = Provider.of<EmailStore>(context, listen: false)
...
class _MailPreview extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    var emailStore = Provider.of<EmailStore>(context, listen: false);
